...
SECRET_KEY=secret-key-xyz-123
CORS_ORIGINS=https://open-notebook-8x8twkj23.vercel.app,https://meu-concurso-elite.pythonanywhere.com
...
echo "  1. Abrir: https://www.pythonanywhere.com/user/meu-concurso-elite/webapps/"
...
echo ""
echo "Endpoints:"
echo "  Health: https://meu-concurso-elite.pythonanywhere.com/health"
echo "  Login:  https://meu-concurso-elite.pythonanywhere.com/api/auth/login-novo"
echo "  Status: https://meu-concurso-elite.pythonanywhere.com/api/auth/status/mr.dblucas@gmail.com"
